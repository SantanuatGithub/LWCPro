...
const { appendChild, cloneNode, compareDocumentPosition, hasChildNodes, insertBefore, removeChild, replaceChild, } = Node.prototype;
...
function pathComposer(startNode, composed) {
    ...
    const startRoot = startNode === window ? window : patchedGetRootNode$1.call(startNode);
    while (current) {
...
const NodePatchDescriptors = {
    ...
    getRootNode: {
        ...
        value(options) {
            ...
            return isFalse(composed) ? this : patchedGetRootNode$1.call(getHost(this), { composed });
        },
    },
};
...
export { createElement$2 as createElement, getComponentDef, isComponentConstructor, getComponentConstructor, BaseLightningElement as LightningElement, register, unwrap$1 as unwrap, registerTemplate, sanitizeAttribute, registerComponent, registerDecorators, isNodeFromTemplate, api, track, readonly, wire, decorate, buildCustomElementConstructor, BaseLightningElement as Element };

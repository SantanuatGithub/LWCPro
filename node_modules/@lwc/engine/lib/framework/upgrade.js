...
function createElement(sel, options) {
    ...
    const fallback = language_1.isUndefined(options.fallback) ||
        language_1.isTrue(options.fallback) ||
        language_1.isFalse(dom_1.isNativeShadowRootAvailable);
    ...
    vm_1.createVM(sel, element, Ctor, { mode, fallback, isRoot: true, owner: null });
